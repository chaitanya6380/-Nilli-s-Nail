        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-24">
          ...
          <div className="space-y-12">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-serif mb-6 sm:mb-8">Reach Out</h1>
          ...
          >
            <h3 className="text-2xl sm:text-3xl font-serif mb-6 sm:mb-8 text-center">Inquiry Form</h3>
