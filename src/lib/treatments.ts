...
export const TREATMENT_CATEGORIES: TreatmentCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Beard Styling', price: '₹180' },
      { name: 'Beard Trimming', price: '₹100' },
      { name: 'Shave', price: '₹200' },
      { name: 'Hair Wash', price: '₹200' },
      { name: 'Hair Styling', price: '₹250' },
      { name: 'Kids Hair Cut', price: '₹300' },
      { name: 'Hair Colour', price: '₹800' },
      { name: 'Beard Colour', price: '₹400' },
      { name: 'Streak', price: '₹200' },
      { name: 'Highlights', price: '₹1200' },
      { name: 'Fashion Colour', price: '₹1500' },
      { name: 'Nourishing Hair Spa', price: '₹1000' },
      { name: 'Dandruff', price: '₹1300' },
      { name: 'Hair Fall Control', price: '₹1500' },
      { name: 'Keratin', price: '₹3000+' },
      { name: 'Smoothening Spa', price: '₹1500' },
      { name: 'Kera Spa', price: '₹1500' },
    ],
  },
];
